<script lang="ts">
	...
	import { handleEnhance } from '$lib/utils/register/handleEnhance';
...
<section class="flex h-220 w-full flex-col items-center justify-end sm:h-full sm:justify-center">
	<form
		autocomplete="off"
		spellcheck="false"
		method="POST"
		use:enhance={handleEnhance}
		class="flex h-[95%] w-full flex-col items-center justify-around gap-6 rounded-t-[60px] bg-krem/80 px-8 pb-40 backdrop-blur-[2px] transition-all duration-600 sm:h-full sm:justify-around sm:rounded-[60px] sm:bg-secondary/0 sm:pb-0 sm:backdrop-blur-none md:gap-8 lg:gap-10 lg:py-16"
	>
		<Title />
